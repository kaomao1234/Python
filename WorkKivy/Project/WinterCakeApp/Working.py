...
<Onboarding@Screen>:
    name:'Logo'
    FitImage:
        source:'C:/Users/borip/OneDrive/Documents/GitHub/PythonWorkShop/WorkKivy/Project/WinterCakeApp/Icon/Nature_Flower_Red_beauty_salon_stamp_Logo_.png'
...
<SignUp@Screen>:
    ...
    MDGridLayout:
        rows:8
        Image:
            source:'C:/Users/borip/OneDrive/Documents/GitHub/PythonWorkShop/WorkKivy/Project/WinterCakeApp/Icon/Nature_Flower_Red_beauty_salon_stamp_Logo_crop.png'
            size_hint_y: None
            height:200
        MDLabel:
            id:title
            ...
            MDGridLayout:
                ...
                AnchorLayout:
                    ...
                    MDRoundFlatButton:
                        ...
                        font_size:16
                        text_color:(0.4588235294117647, 0.2823529411764706, 0.2784313725490196, 1.0)
                        line_color:(0.4588235294117647, 0.2823529411764706, 0.2784313725490196, 1.0)
                AnchorLayout:
                    anchor_x: 'center'
                    MDRoundFlatButton:
                        id:account_btn
...
<SignIn@Screen>:
    ...
    MDGridLayout:
        ...
        MDLabel:
            id:title
            text:'[size=20][b]Sign Up For Free[/b][/size]'
            size_hint_y: None
            halign: "center"
            valign:'center'
            markup: True
...
class sm(ScreenManager):
    def __init__(self, **kwargs):
        ...
        sign_up = SignUp()
        sign_in = SignIn()
        self.add_widget(onboard)
        self.add_widget(sign_up)
        self.add_widget(sign_in)
        Clock.schedule_once(self.waiting, 5)
        sign_in.back_btn.bind(on_press=lambda *e :self.switchPage(sign_up.name))
        sign_up.account_btn.bind(on_press=lambda *e: self.switchPage(sign_in.name,'left'))

    def waiting(self, *e):
        self.current = 'Sigup'

    def switchPage(self,name:str,transition='right'):
        self.transition = SlideTransition(direction=transition)
        self.current = name
