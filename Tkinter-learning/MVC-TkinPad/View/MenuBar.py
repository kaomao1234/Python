...
class MenuBar(ttk.Frame):
    def __init__(self,controller,master):
        ...
        self.file_btn = ttk.Menubutton(self,text='File',bootstyle='outline-primary')
        self.edit_btn = ttk.Menubutton(self,text='Edit',bootstyle='outline-primary')
        self.format_btn = ttk.Menubutton(self,text='Format',bootstyle='outline-primary')
        self.view_btn = ttk.Menubutton(self,text='View',bootstyle='outline-primary')
        self.help_btn = ttk.Menubutton(self,text='Help',bootstyle='outline-primary')
    ...
    def edit_menu_config(self):
        ...
        self.edit_menu.add_command(label='Undo', accelerator='Ctrl+Z',command=partial(textArea.event_generate,'<<Undo>>'))
        self.edit_menu.add_separator()
        self.edit_menu.add_command(
            label="Cut", accelerator='Ctrl+X',command=partial(textArea.event_generate,'<<Cut>>'))
        self.edit_menu.add_command(
            label="Copy", accelerator='Ctrl+C'
            ,command=partial(textArea.event_generate,'<<Copy>>'))
        self.edit_menu.add_command(
            label="Paste", accelerator='Ctrl+V',
            command=partial(textArea.event_generate,'<<Paste>>'))
        self.edit_menu.add_command(
            label="Delete",command=partial(textArea.event_generate,'<Delete>'))
        self.edit_menu.add_separator()
        self.edit_menu.add_command(
